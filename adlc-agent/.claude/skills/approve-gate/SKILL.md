---
name: approve-gate
description: "Record a human decision on an ADLC gate: approve, reject with reason, or (waiver approvers only) waive. Must be run by the approver in their own session. User-invoked only."
