      ...
      <div className="container-frame">
        <div className="container flex h-14 items-center gap-2 md:gap-4">
          ...
          <nav className="ml-auto flex items-center gap-1.5 sm:gap-2">
            ...
            <Link
              href="#demo"
              className="hidden h-8 items-center rounded-full border border-black/8 bg-neutral-100/70 px-3.5 font-mono text-[12px] uppercase tracking-[0.5px] text-foreground/70 transition-colors hover:bg-neutral-100 hover:text-foreground sm:inline-flex dark:border-white/10 dark:bg-neutral-900/70 dark:hover:bg-neutral-900"
            >
              Book a demo
            </Link>
            <Link
